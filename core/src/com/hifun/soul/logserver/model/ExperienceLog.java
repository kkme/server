 ...
 */
public class ExperienceLog extends BaseLogMessage{
    ...
    public ExperienceLog(
        ...
        super(MessageType.LOG_EXPERIENCE_RECORD,logTime,regionId,serverId,accountId,accountName,charId,charName,level,allianceId,vipLevel,reason,param);
    ...
    public short getType() {
        return MessageType.LOG_EXPERIENCE_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_EXPERIENCE_RECORD";
    }
}