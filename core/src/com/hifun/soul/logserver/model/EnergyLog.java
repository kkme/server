 ...
 */
public class EnergyLog extends BaseLogMessage{
    ...
    public EnergyLog(
        ...
        super(MessageType.LOG_ENERGY_RECORD,logTime,regionId,serverId,accountId,accountName,charId,charName,level,allianceId,vipLevel,reason,param);
    ...
    public short getType() {
        return MessageType.LOG_ENERGY_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_ENERGY_RECORD";
    }
}