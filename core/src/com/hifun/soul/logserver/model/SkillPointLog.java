 ...
 */
public class SkillPointLog extends BaseLogMessage{
       private int changeNum;
       private int afterChangeNum;
    
    public SkillPointLog() {    	
    }
    ...
    public SkillPointLog(
        ...
        super(MessageType.LOG_SKILLPOINT_RECORD,logTime,regionId,serverId,accountId,accountName,charId,charName,level,allianceId,vipLevel,reason,param);
    ...
    public short getType() {
        return MessageType.LOG_SKILLPOINT_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_SKILLPOINT_RECORD";
    }
}