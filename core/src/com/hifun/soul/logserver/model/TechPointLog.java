 ...
 */
public class TechPointLog extends BaseLogMessage{
    ...
    public TechPointLog(
        ...
        super(MessageType.LOG_TECHPOINT_RECORD,logTime,regionId,serverId,accountId,accountName,charId,charName,level,allianceId,vipLevel,reason,param);
    ...
    public short getType() {
        return MessageType.LOG_TECHPOINT_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_TECHPOINT_RECORD";
    }
}