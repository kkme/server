package com.hifun.soul.core.msg.filter;
...
class FloodRecode {
	 ...
	 * 最大连接极限
	 */
	public static final int MAX_CLIENTS_LIMIT = 10000;
	
	/**
	 * 最大连接数
	 */
	// editby: crazyjohn 最大的连接数修改为10000;
	public static final int MAX_CLIENTS_ACTIVE = 10000;
