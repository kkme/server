...
import com.hifun.soul.common.constants.RoleConstants;
...
public class LevelRangeValidater {
	 ...
	 * @param ranges
	 */
	public void checkLevelRanges(Collection<ITemplateLevelRange> ranges) {
		for (ITemplateLevelRange range : ranges) {
	 ...
	 * @param range
	 */
	public void checkLevelRange(ITemplateLevelRange range) {
