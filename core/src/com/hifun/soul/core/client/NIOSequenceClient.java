package com.hifun.soul.core.client;
...
import com.hifun.soul.core.handler.ClientToServerIoHandler;
import com.hifun.soul.core.msg.IMessage;
import com.hifun.soul.core.msg.recognizer.IMessageRecognizer;
import com.hifun.soul.core.msg.special.SequenceMessage;
		...
		IMessageProcessor _processorWrapper = new IMessageProcessor() {
			...
			public void put(final IMessage msg) {
				...
				if (msg instanceof SequenceMessage) {
					...
					logger.info("The server connection closed,cancel all sequence request");
					cancelAllSequence();
					return;
				}
