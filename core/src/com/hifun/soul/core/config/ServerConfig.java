...
public abstract class ServerConfig implements Config {
	/**
	 * 服务器类型：1-GameServer 2-WorldServer 3-LoginServer 4-DBSServer 5-AgentServer
	 * 6-LogServer
	 */
	...
	/** 是否在启动时加载所有角色 */
	private boolean loadAllHumansToCache = true;
	...
	/** 性能探针配置 */
	//private ProbeConfig probeConfig = new ProbeConfig();
