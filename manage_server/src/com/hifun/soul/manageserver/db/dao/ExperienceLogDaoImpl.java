...
public class ExperienceLogDaoImpl extends AbstractLogDao implements IExperienceLogDao {
	...
	@Override
	public List<ExperienceLog> queryExperienceLogList(Date beginDate, Date endDate, String sqlWhere, int start, int maxCount) {
		List<ExperienceLog> resultList = new ArrayList<ExperienceLog>();		
		...
		try {
			...
			while (rs.next()) {
				ExperienceLog.Builder logBuilder = ExperienceLog.newBuilder();
