...
public class EnergyLogDaoImpl extends AbstractLogDao implements IEnergyLogDao {
	...
	@Override
	public List<EnergyLog> queryEnergyLogList(Date beginDate, Date endDate, String sqlWhere, int start, int maxCount) {
		List<EnergyLog> resultList = new ArrayList<EnergyLog>();		
		...
		try {
			...
			while (rs.next()) {
				EnergyLog.Builder logBuilder = EnergyLog.newBuilder();
