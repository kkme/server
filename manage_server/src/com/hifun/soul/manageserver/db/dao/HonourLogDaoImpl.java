...
public class HonourLogDaoImpl extends AbstractLogDao implements IHonourLogDao {
	...
	@Override
	public List<HonourLog> queryHonourLogList(Date beginDate, Date endDate, String sqlWhere, int start, int maxCount) {
		List<HonourLog> resultList = new ArrayList<HonourLog>();		
		...
		try {
			...
			while (rs.next()) {
				HonourLog.Builder logBuilder = HonourLog.newBuilder();
