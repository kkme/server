 ...
 *
 */
public class FriendLogDaoImpl extends AbstractLogDao implements IFriendLogDao {
	...
	@Override
	public List<FriendLog> queryFriendLogList(Date beginDate, Date endDate, String sqlWhere, int start, int maxCount) {
		List<FriendLog> resultList = new ArrayList<FriendLog>();		
		...
		for (int i = 0; i <= daySpan; i++) {
			...
			sbUnion.append("friend_passport_id,");
			sbUnion.append("friend_passport_name,");
			sbUnion.append("friend_role_id,");
			sbUnion.append("friend_role_name,");
		...
		sb.append("reason,");
		sb.append("param,");
		sb.append("friend_passport_id,");
		sb.append("friend_passport_name,");
		sb.append("friend_role_id,");
		sb.append("friend_role_name,");
		...
		try {
			...
			while (rs.next()) {
				FriendLog.Builder logBuilder = FriendLog.newBuilder();
				...
				logBuilder.setFriendPassportId(rs.getLong(14));
				logBuilder.setFriendPassportName(rs.getString(15));
				logBuilder.setFriendRoleId(rs.getLong(16));
				logBuilder.setFriendRoleName(rs.getString(17));
				logBuilder.setCreateTime(rs.getLong(18));
