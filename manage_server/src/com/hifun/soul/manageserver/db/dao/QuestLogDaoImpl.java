 ...
 *
 */
public class QuestLogDaoImpl extends AbstractLogDao implements IQuestLogDao {
	...
	@Override
	public List<QuestLog> queryQuestLogList(Date beginDate, Date endDate, String sqlWhere, int start, int maxCount) {
		List<QuestLog> resultList = new ArrayList<QuestLog>();		
		...
		try {
			...
			while (rs.next()) {
				QuestLog.Builder logBuilder = QuestLog.newBuilder();
				...
				logBuilder.setQuestId(rs.getInt(14));					
