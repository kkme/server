...
import com.hifun.soul.manageserver.msg.GMUpdateMarketActSetting;
import com.hifun.soul.proto.services.Services.UpdateMarketActSettingResponse;

@Component
public class GMUpdateMarketActSettingHandler implements IMessageHandlerWithType<GMUpdateMarketActSetting> {
	@Autowired
	...
	@Override
	public void execute(GMUpdateMarketActSetting message) {
		RpcCallback<UpdateMarketActSettingResponse> callback = manager
		...
		callback.run(UpdateMarketActSettingResponse.newBuilder()
