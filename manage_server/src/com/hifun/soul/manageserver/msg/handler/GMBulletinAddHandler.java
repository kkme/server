...
import com.hifun.soul.manageserver.msg.GMBulletinAdd;
import com.hifun.soul.proto.services.Services.AddBulletinResponse;

@Component
public class GMBulletinAddHandler implements IMessageHandlerWithType<GMBulletinAdd> {
	...
	@Override
	public void execute(GMBulletinAdd message) {
		RpcCallback<AddBulletinResponse> callback = manager
		...
		callback.run(AddBulletinResponse.newBuilder()
