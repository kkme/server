...
import com.hifun.soul.manageserver.msg.GMCancelMail;
import com.hifun.soul.proto.services.Services.CancelTimingMailResponse;

@Component
public class GMCancelMailHandler implements IMessageHandlerWithType<GMCancelMail> {
	@Autowired
	...
	@Override
	public void execute(GMCancelMail message) {
		RpcCallback<CancelTimingMailResponse> callback = manager
		...
		callback.run(CancelTimingMailResponse.newBuilder()
