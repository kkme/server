...
import com.hifun.soul.manageserver.msg.GMSendMail;
import com.hifun.soul.proto.services.Services.SendMailResponse;

@Component
public class GMSendMailHandler implements IMessageHandlerWithType<GMSendMail> {
	@Autowired
	private RpcCallbackManager manager;
	private Logger logger = Loggers.MANAGE_MAIN_LOGGER;
	@Override
	public short getMessageType() {
		return MessageType.GM_SEND_MAIL;
	}

	@Override
	public void execute(GMSendMail message) {
		RpcCallback<SendMailResponse> callback = manager
		...
		callback.run(SendMailResponse.newBuilder()
