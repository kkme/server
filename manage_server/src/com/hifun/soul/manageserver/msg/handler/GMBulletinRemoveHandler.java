...
import com.hifun.soul.manageserver.msg.GMBulletinRemove;
import com.hifun.soul.proto.services.Services.RemoveBulletinResponse;

@Component
public class GMBulletinRemoveHandler implements IMessageHandlerWithType<GMBulletinRemove> {
	@Autowired
	...
	@Override
	public void execute(GMBulletinRemove message) {
		RpcCallback<RemoveBulletinResponse> callback = manager
		...
		callback.run(RemoveBulletinResponse.newBuilder()
