 ...
 */
@Component
public class GCViewArenaRankRewardInfo extends GCMessage{
	
	/** 奖励物品列表 */
	private com.hifun.soul.gameserver.item.assist.CommonItem[] items;

	public GCViewArenaRankRewardInfo (){
	}
	...
	public short getType() {
		return MessageType.GC_VIEW_ARENA_RANK_REWARD_INFO;
	}
	
	@Override
	public String getTypeName() {
		return "GC_VIEW_ARENA_RANK_REWARD_INFO";
	}
