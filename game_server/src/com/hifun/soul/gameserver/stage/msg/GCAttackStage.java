 ...
 */
@Component
public class GCAttackStage extends GCMessage{
	...
	public short getType() {
		return MessageType.GC_ATTACK_STAGE;
	}
	
	@Override
	public String getTypeName() {
		return "GC_ATTACK_STAGE";
	}
