...
@ExcelRowBinding
public abstract class MagicPaperBuffTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "MagicPaperBuffTemplateVO[needEquipBitLevel=" + needEquipBitLevel + ",propertyId=" + propertyId + ",amendEffect=" + amendEffect + ",amendMethod=" + amendMethod + ",]";
