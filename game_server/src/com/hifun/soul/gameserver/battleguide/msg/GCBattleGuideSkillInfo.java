 ...
 */
@Component
public class GCBattleGuideSkillInfo extends GCMessage{
	...
	public short getType() {
		return MessageType.GC_BATTLE_GUIDE_SKILL_INFO;
	}
	
	@Override
	public String getTypeName() {
		return "GC_BATTLE_GUIDE_SKILL_INFO";
	}
