 ...
 */
@Component
public class GCBattleGuideUseSkill extends GCMessage{
	...
	public short getType() {
		return MessageType.GC_BATTLE_GUIDE_USE_SKILL;
	}
	
	@Override
	public String getTypeName() {
		return "GC_BATTLE_GUIDE_USE_SKILL";
	}
