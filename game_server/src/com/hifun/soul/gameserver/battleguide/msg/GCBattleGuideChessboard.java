 ...
 */
@Component
public class GCBattleGuideChessboard extends GCMessage{
	...
	public GCBattleGuideChessboard (){
	}
	...
	public short getType() {
		return MessageType.GC_BATTLE_GUIDE_CHESSBOARD;
	}
	
	@Override
	public String getTypeName() {
		return "GC_BATTLE_GUIDE_CHESSBOARD";
	}
