 ...
 */
@Component
public class GCBattleGuideThreeBombs extends GCMessage{
	...
	public GCBattleGuideThreeBombs (){
	}
	...
	public short getType() {
		return MessageType.GC_BATTLE_GUIDE_THREE_BOMBS;
	}
	
	@Override
	public String getTypeName() {
		return "GC_BATTLE_GUIDE_THREE_BOMBS";
	}
