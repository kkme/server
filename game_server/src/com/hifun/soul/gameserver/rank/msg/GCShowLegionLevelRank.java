 ...
 */
@Component
public class GCShowLegionLevelRank extends GCMessage{
	...
	/** 排行榜数据列表 */
	private com.hifun.soul.gameserver.rank.model.LegionLevelRankData[] rankDatas;

	public GCShowLegionLevelRank (){
	}
	
	public GCShowLegionLevelRank (
			int rankSize,
			int humanRankPosition,
			com.hifun.soul.gameserver.rank.model.LegionLevelRankData[] rankDatas ){
	...
	protected boolean readImpl() {
		...
		rankDatas = new com.hifun.soul.gameserver.rank.model.LegionLevelRankData[count];
		for(int i=0; i<count; i++){
			com.hifun.soul.gameserver.rank.model.LegionLevelRankData objrankDatas = new com.hifun.soul.gameserver.rank.model.LegionLevelRankData();
	...
	com.hifun.soul.gameserver.rank.model.LegionLevelRankData objrankDatas = rankDatas[i];
	...
	public short getType() {
		return MessageType.GC_SHOW_LEGION_LEVEL_RANK;
	}
	
	@Override
	public String getTypeName() {
		return "GC_SHOW_LEGION_LEVEL_RANK";
	}
	...
	public com.hifun.soul.gameserver.rank.model.LegionLevelRankData[] getRankDatas(){
		return rankDatas;
	}

	public void setRankDatas(com.hifun.soul.gameserver.rank.model.LegionLevelRankData[] rankDatas){
		this.rankDatas = rankDatas;
	}	
}