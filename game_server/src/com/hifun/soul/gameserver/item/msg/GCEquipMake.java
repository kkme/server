 ...
 */
@Component
public class GCEquipMake extends GCMessage{
	
	/** 装备打造结果：false失败，true成功 */
	private boolean makeResult;
	/** 物品列表 */
	...
	public short getType() {
		return MessageType.GC_EQUIP_MAKE;
	}
	
	@Override
	public String getTypeName() {
		return "GC_EQUIP_MAKE";
	}

	public boolean getMakeResult(){
		return makeResult;
	}
		
	public void setMakeResult(boolean makeResult){
		this.makeResult = makeResult;
	}
