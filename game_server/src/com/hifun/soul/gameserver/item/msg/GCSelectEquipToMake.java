 ...
 */
@Component
public class GCSelectEquipToMake extends GCMessage{
	...
	/** 所需图纸 */
	private com.hifun.soul.gameserver.item.assist.CommonItem paper;

	public GCSelectEquipToMake (){
	}
	...
	public GCSelectEquipToMake (
			...
			int equipNum,
			String[] guides,
			com.hifun.soul.gameserver.item.assist.CommonItem paper ){
	...
	for(int jmaterialsOfEquipPaper = 0; jmaterialsOfEquipPaper < subCountmaterialsOfEquipPaper; jmaterialsOfEquipPaper++){
		...
		paper = new com.hifun.soul.gameserver.item.assist.CommonItem();
						paper.setUUID(readString());
						paper.setItemId(readInteger());
						paper.setName(readString());
						paper.setDesc(readString());
						paper.setType(readInteger());
						paper.setIcon(readInteger());
						paper.setRarity(readInteger());
						paper.setBind(readInteger());
						paper.setOverlapNum(readInteger());
						paper.setBagType(readInteger());
						paper.setBagIndex(readInteger());
						paper.setSellCurrencyType(readShort());
						paper.setSellNum(readInteger());
						paper.setPosition(readInteger());
						paper.setEndure(readInteger());
						paper.setEquipHole(readShort());
						paper.setEmbedCurrencyType(readShort());
						paper.setEmbedCurrencyNum(readInteger());
						paper.setExtractCurrencyType(readShort());
						paper.setExtractCurrencyNum(readInteger());
						paper.setShopCurrencyType(readShort());
						paper.setShopCurrencyNum(readInteger());
							{
	int subCountequipBaseAttributes = readShort();
		com.hifun.soul.core.util.KeyValuePair<Integer,Integer>[] subListequipBaseAttributes  = com.hifun.soul.core.util.KeyValuePair.newKeyValuePairArray(subCountequipBaseAttributes);
		paper.setEquipBaseAttributes(subListequipBaseAttributes);
	for(int jequipBaseAttributes = 0; jequipBaseAttributes < subCountequipBaseAttributes; jequipBaseAttributes++){
						com.hifun.soul.core.util.KeyValuePair<Integer,Integer> objequipBaseAttributes = new com.hifun.soul.core.util.KeyValuePair<Integer,Integer>();
		subListequipBaseAttributes[jequipBaseAttributes] = objequipBaseAttributes;
						objequipBaseAttributes.setKey(readInteger());
	...
	int subCountequipSpecialAttributes = readShort();
		com.hifun.soul.core.util.KeyValuePair<Integer,Integer>[] subListequipSpecialAttributes  = com.hifun.soul.core.util.KeyValuePair.newKeyValuePairArray(subCountequipSpecialAttributes);
		paper.setEquipSpecialAttributes(subListequipSpecialAttributes);
	for(int jequipSpecialAttributes = 0; jequipSpecialAttributes < subCountequipSpecialAttributes; jequipSpecialAttributes++){
						com.hifun.soul.core.util.KeyValuePair<Integer,Integer> objequipSpecialAttributes = new com.hifun.soul.core.util.KeyValuePair<Integer,Integer>();
		subListequipSpecialAttributes[jequipSpecialAttributes] = objequipSpecialAttributes;
						objequipSpecialAttributes.setKey(readInteger());
	...
	int subCountgemAttributes = readShort();
		com.hifun.soul.core.util.KeyValuePair<Integer,Integer>[] subListgemAttributes  = com.hifun.soul.core.util.KeyValuePair.newKeyValuePairArray(subCountgemAttributes);
		paper.setGemAttributes(subListgemAttributes);
	for(int jgemAttributes = 0; jgemAttributes < subCountgemAttributes; jgemAttributes++){
						com.hifun.soul.core.util.KeyValuePair<Integer,Integer> objgemAttributes = new com.hifun.soul.core.util.KeyValuePair<Integer,Integer>();
		subListgemAttributes[jgemAttributes] = objgemAttributes;
						objgemAttributes.setKey(readInteger());
	...
	int subCountequipGemItemInfos = readShort();
		com.hifun.soul.gameserver.item.assist.GemItemInfo[] subListequipGemItemInfos = new com.hifun.soul.gameserver.item.assist.GemItemInfo[subCountequipGemItemInfos];
		paper.setEquipGemItemInfos(subListequipGemItemInfos);
	for(int jequipGemItemInfos = 0; jequipGemItemInfos < subCountequipGemItemInfos; jequipGemItemInfos++){
						com.hifun.soul.gameserver.item.assist.GemItemInfo objequipGemItemInfos = new com.hifun.soul.gameserver.item.assist.GemItemInfo();
		subListequipGemItemInfos[jequipGemItemInfos] = objequipGemItemInfos;
						objequipGemItemInfos.setItemId(readInteger());
	...
	int subCountequipUpgradeAttributes = readShort();
		com.hifun.soul.core.util.KeyValuePair<Integer,Integer>[] subListequipUpgradeAttributes  = com.hifun.soul.core.util.KeyValuePair.newKeyValuePairArray(subCountequipUpgradeAttributes);
		paper.setEquipUpgradeAttributes(subListequipUpgradeAttributes);
	for(int jequipUpgradeAttributes = 0; jequipUpgradeAttributes < subCountequipUpgradeAttributes; jequipUpgradeAttributes++){
						com.hifun.soul.core.util.KeyValuePair<Integer,Integer> objequipUpgradeAttributes = new com.hifun.soul.core.util.KeyValuePair<Integer,Integer>();
		subListequipUpgradeAttributes[jequipUpgradeAttributes] = objequipUpgradeAttributes;
						objequipUpgradeAttributes.setKey(readInteger());
						...
						paper.setExtraSuccessRate(readFloat());
						paper.setUpgradeLevel(readInteger());
						paper.setLimitLevel(readInteger());
						paper.setLimitOccupation(readInteger());
						paper.setMaxEquipHole(readInteger());
							{
	int subCountmaterialsOfEquipPaper = readShort();
		com.hifun.soul.core.util.KeyValuePair<String,Integer>[] subListmaterialsOfEquipPaper  = com.hifun.soul.core.util.KeyValuePair.newKeyValuePairArray(subCountmaterialsOfEquipPaper);
		paper.setMaterialsOfEquipPaper(subListmaterialsOfEquipPaper);
	for(int jmaterialsOfEquipPaper = 0; jmaterialsOfEquipPaper < subCountmaterialsOfEquipPaper; jmaterialsOfEquipPaper++){
						com.hifun.soul.core.util.KeyValuePair<String,Integer> objmaterialsOfEquipPaper = new com.hifun.soul.core.util.KeyValuePair<String,Integer>();
		subListmaterialsOfEquipPaper[jmaterialsOfEquipPaper] = objmaterialsOfEquipPaper;
						objmaterialsOfEquipPaper.setKey(readString());
						...
						paper.setMaxOverlap(readInteger());
						paper.setIsEquiped(readBoolean());
						paper.setCanSell(readBoolean());
				return true;
	}
	...
	String objguides = guides[i];
		...
		writeString(paper.getUUID());
		writeInteger(paper.getItemId());
		writeString(paper.getName());
		writeString(paper.getDesc());
		writeInteger(paper.getType());
		writeInteger(paper.getIcon());
		writeInteger(paper.getRarity());
		writeInteger(paper.getBind());
		writeInteger(paper.getOverlapNum());
		writeInteger(paper.getBagType());
		writeInteger(paper.getBagIndex());
		writeShort(paper.getSellCurrencyType());
		writeInteger(paper.getSellNum());
		writeInteger(paper.getPosition());
		writeInteger(paper.getEndure());
		writeShort(paper.getEquipHole());
		writeShort(paper.getEmbedCurrencyType());
		writeInteger(paper.getEmbedCurrencyNum());
		writeShort(paper.getExtractCurrencyType());
		writeInteger(paper.getExtractCurrencyNum());
		writeShort(paper.getShopCurrencyType());
		writeInteger(paper.getShopCurrencyNum());
			com.hifun.soul.core.util.KeyValuePair<Integer,Integer>[] equipBaseAttributes_paper=paper.getEquipBaseAttributes();
	writeShort(equipBaseAttributes_paper.length);
	for(int jequipBaseAttributes=0; jequipBaseAttributes<equipBaseAttributes_paper.length; jequipBaseAttributes++){
					com.hifun.soul.core.util.KeyValuePair<Integer,Integer> equipBaseAttributes_paper_jequipBaseAttributes = equipBaseAttributes_paper[jequipBaseAttributes];
													writeInteger(equipBaseAttributes_paper_jequipBaseAttributes.getKey());
													writeInteger(equipBaseAttributes_paper_jequipBaseAttributes.getValue());
									}
			com.hifun.soul.core.util.KeyValuePair<Integer,Integer>[] equipSpecialAttributes_paper=paper.getEquipSpecialAttributes();
	writeShort(equipSpecialAttributes_paper.length);
	for(int jequipSpecialAttributes=0; jequipSpecialAttributes<equipSpecialAttributes_paper.length; jequipSpecialAttributes++){
					com.hifun.soul.core.util.KeyValuePair<Integer,Integer> equipSpecialAttributes_paper_jequipSpecialAttributes = equipSpecialAttributes_paper[jequipSpecialAttributes];
													writeInteger(equipSpecialAttributes_paper_jequipSpecialAttributes.getKey());
													writeInteger(equipSpecialAttributes_paper_jequipSpecialAttributes.getValue());
									}
			com.hifun.soul.core.util.KeyValuePair<Integer,Integer>[] gemAttributes_paper=paper.getGemAttributes();
	writeShort(gemAttributes_paper.length);
	for(int jgemAttributes=0; jgemAttributes<gemAttributes_paper.length; jgemAttributes++){
					com.hifun.soul.core.util.KeyValuePair<Integer,Integer> gemAttributes_paper_jgemAttributes = gemAttributes_paper[jgemAttributes];
													writeInteger(gemAttributes_paper_jgemAttributes.getKey());
													writeInteger(gemAttributes_paper_jgemAttributes.getValue());
									}
			com.hifun.soul.gameserver.item.assist.GemItemInfo[] equipGemItemInfos_paper=paper.getEquipGemItemInfos();
	writeShort(equipGemItemInfos_paper.length);
	for(int jequipGemItemInfos=0; jequipGemItemInfos<equipGemItemInfos_paper.length; jequipGemItemInfos++){
					com.hifun.soul.gameserver.item.assist.GemItemInfo equipGemItemInfos_paper_jequipGemItemInfos = equipGemItemInfos_paper[jequipGemItemInfos];
													writeInteger(equipGemItemInfos_paper_jequipGemItemInfos.getItemId());
													writeInteger(equipGemItemInfos_paper_jequipGemItemInfos.getIndex());
													writeInteger(equipGemItemInfos_paper_jequipGemItemInfos.getRarity());
														com.hifun.soul.core.util.KeyValuePair<Integer,Integer>[] equipGemAttributes_equipGemItemInfos_paper_jequipGemItemInfos=equipGemItemInfos_paper_jequipGemItemInfos.getEquipGemAttributes();
	writeShort(equipGemAttributes_equipGemItemInfos_paper_jequipGemItemInfos.length);
	for(int jequipGemAttributes=0; jequipGemAttributes<equipGemAttributes_equipGemItemInfos_paper_jequipGemItemInfos.length; jequipGemAttributes++){
					com.hifun.soul.core.util.KeyValuePair<Integer,Integer> equipGemAttributes_equipGemItemInfos_paper_jequipGemItemInfos_jequipGemAttributes = equipGemAttributes_equipGemItemInfos_paper_jequipGemItemInfos[jequipGemAttributes];
													writeInteger(equipGemAttributes_equipGemItemInfos_paper_jequipGemItemInfos_jequipGemAttributes.getKey());
													writeInteger(equipGemAttributes_equipGemItemInfos_paper_jequipGemItemInfos_jequipGemAttributes.getValue());
									}
									}
			com.hifun.soul.core.util.KeyValuePair<Integer,Integer>[] equipUpgradeAttributes_paper=paper.getEquipUpgradeAttributes();
	writeShort(equipUpgradeAttributes_paper.length);
	for(int jequipUpgradeAttributes=0; jequipUpgradeAttributes<equipUpgradeAttributes_paper.length; jequipUpgradeAttributes++){
					com.hifun.soul.core.util.KeyValuePair<Integer,Integer> equipUpgradeAttributes_paper_jequipUpgradeAttributes = equipUpgradeAttributes_paper[jequipUpgradeAttributes];
													writeInteger(equipUpgradeAttributes_paper_jequipUpgradeAttributes.getKey());
													writeInteger(equipUpgradeAttributes_paper_jequipUpgradeAttributes.getValue());
									}
		writeFloat(paper.getExtraSuccessRate());
		writeInteger(paper.getUpgradeLevel());
		writeInteger(paper.getLimitLevel());
		writeInteger(paper.getLimitOccupation());
		writeInteger(paper.getMaxEquipHole());
			com.hifun.soul.core.util.KeyValuePair<String,Integer>[] materialsOfEquipPaper_paper=paper.getMaterialsOfEquipPaper();
	writeShort(materialsOfEquipPaper_paper.length);
	for(int jmaterialsOfEquipPaper=0; jmaterialsOfEquipPaper<materialsOfEquipPaper_paper.length; jmaterialsOfEquipPaper++){
					com.hifun.soul.core.util.KeyValuePair<String,Integer> materialsOfEquipPaper_paper_jmaterialsOfEquipPaper = materialsOfEquipPaper_paper[jmaterialsOfEquipPaper];
													writeString(materialsOfEquipPaper_paper_jmaterialsOfEquipPaper.getKey());
													writeInteger(materialsOfEquipPaper_paper_jmaterialsOfEquipPaper.getValue());
									}
		writeInteger(paper.getMaxOverlap());
		writeBoolean(paper.getIsEquiped());
		writeBoolean(paper.getCanSell());
		return true;
	}
	
	@Override
	public short getType() {
		return MessageType.GC_SELECT_EQUIP_TO_MAKE;
	}
	
	@Override
	public String getTypeName() {
		return "GC_SELECT_EQUIP_TO_MAKE";
	}
	...
	public com.hifun.soul.gameserver.item.assist.CommonItem getPaper(){
		return paper;
	}
		
	public void setPaper(com.hifun.soul.gameserver.item.assist.CommonItem paper){
		this.paper = paper;
	}
}