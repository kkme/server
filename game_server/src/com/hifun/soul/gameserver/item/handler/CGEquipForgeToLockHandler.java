...
@Component
public class CGEquipForgeToLockHandler implements
		IMessageHandlerWithType<CGEquipForgeToLock> {
	...
	@Override
	public void execute(CGEquipForgeToLock message) {
		...
		// 更新洗练的消耗信息
		human.getHumanForgeManager().updateForgeCost(equipItem, message.getLockNum());
	}
