 ...
 * 
 */
public class DailyGiftUpgradeAimCounter extends AbstractDailyQuestAimCounter {

	public DailyGiftUpgradeAimCounter(IQuestAimType type, AimInfo aim, int index) {
		super(type, aim, index);
	}

	@Override
	public EnumSet<EventType> getEventTypeSet() {
		return EnumSet.of(EventType.GIFT_UPGRADE_EVENT);
	}

	@Override
	public boolean onQuestEvent(IEvent event) {
		switch (event.getType()) {
		case GIFT_UPGRADE_EVENT: {
