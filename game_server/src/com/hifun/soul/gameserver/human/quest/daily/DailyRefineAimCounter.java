 ...
 * 
 */
public class DailyRefineAimCounter extends AbstractDailyQuestAimCounter {

	public DailyRefineAimCounter(IQuestAimType type, AimInfo aim, int index) {
		super(type, aim, index);
	}

	@Override
	public EnumSet<EventType> getEventTypeSet() {
		return EnumSet.of(EventType.REFINE_CHALLENGE_EVENT);
	}

	@Override
	public boolean onQuestEvent(IEvent event) {
		switch (event.getType()) {
		case REFINE_CHALLENGE_EVENT: {
