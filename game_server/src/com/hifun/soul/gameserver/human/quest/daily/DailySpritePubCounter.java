 ...
 * 
 */
public class DailySpritePubCounter extends AbstractDailyQuestAimCounter {

	public DailySpritePubCounter(IQuestAimType type, AimInfo aim, int index) {
		super(type, aim, index);
	}

	@Override
	public EnumSet<EventType> getEventTypeSet() {
		return EnumSet.of(EventType.SPRITE_PUB_EVENT);
	}

	@Override
	public boolean onQuestEvent(IEvent event) {
		switch (event.getType()) {
		case SPRITE_PUB_EVENT: {
