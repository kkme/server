 ...
 * 
 */
public class DailyStarMapActivateAimCounter extends
		AbstractDailyQuestAimCounter {

	public DailyStarMapActivateAimCounter(IQuestAimType type, AimInfo aim,
			int index) {
	...
	public EnumSet<EventType> getEventTypeSet() {
		return EnumSet.of(EventType.STAR_MAP_ACTIVATE_EVENT);
	}

	@Override
	public boolean onQuestEvent(IEvent event) {
		switch (event.getType()) {
		case STAR_MAP_ACTIVATE_EVENT: {
