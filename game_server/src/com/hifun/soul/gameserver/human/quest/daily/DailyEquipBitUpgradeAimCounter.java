 ...
 * 
 */
public class DailyEquipBitUpgradeAimCounter extends
		AbstractDailyQuestAimCounter {

	public DailyEquipBitUpgradeAimCounter(IQuestAimType type, AimInfo aim,
			int index) {
	...
	public EnumSet<EventType> getEventTypeSet() {
		return EnumSet.of(EventType.EQUIP_BIT_UPGRADE_EVENT);
	}

	@Override
	public boolean onQuestEvent(IEvent event) {
		switch (event.getType()) {
		case EQUIP_BIT_UPGRADE_EVENT: {
