 ...
 * 
 */
public class DailyUpgradeTechAimCounter extends AbstractDailyQuestAimCounter {

	public DailyUpgradeTechAimCounter(IQuestAimType type, AimInfo aim, int index) {
		super(type, aim, index);
	}

	@Override
	public EnumSet<EventType> getEventTypeSet() {
		return EnumSet.of(EventType.TECH_UPGRADE_EVENT);
	}

	@Override
	public boolean onQuestEvent(IEvent event) {
		switch (event.getType()) {
		case TECH_UPGRADE_EVENT: {
