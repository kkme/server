 ...
 * 
 */
public class DailySpriteUpgradeAimCounter extends AbstractDailyQuestAimCounter {

	public DailySpriteUpgradeAimCounter(IQuestAimType type, AimInfo aim,
			int index) {
	...
	public EnumSet<EventType> getEventTypeSet() {
		return EnumSet.of(EventType.SPRITE_UPGRADE_EVENT);
	}

	@Override
	public boolean onQuestEvent(IEvent event) {
		switch (event.getType()) {
		case SPRITE_UPGRADE_EVENT: {
