 ...
 */
@Component
public class GCAttackRefineStageFirst extends GCMessage{
	...
	public GCAttackRefineStageFirst (){
	}
	...
	public short getType() {
		return MessageType.GC_ATTACK_REFINE_STAGE_FIRST;
	}
	
	@Override
	public String getTypeName() {
		return "GC_ATTACK_REFINE_STAGE_FIRST";
	}
