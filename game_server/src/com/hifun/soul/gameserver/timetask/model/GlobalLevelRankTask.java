...
@Component
public class GlobalLevelRankTask extends AbstractDailyTask {
	@Autowired
	...
	public int getTimeTaskType() {
		return TimeTaskType.HUMAN_LEVEL_RANK_REFRESH.getIndex();
	}

	@Override
	public long getLastRunTime() {
		return globalTimeTaskManager
				.getLastRunTime(GlobalKeyConstants.LEVEL_RANK_REFRESH_TIME);
	}

	@Override
	public void setLastRunTime(long time) {
		globalTimeTaskManager.setLastRunTime(
				GlobalKeyConstants.LEVEL_RANK_REFRESH_TIME, time);
	}
	...
	public void run() {
		...
		rankManager.refreshRankData(RankType.HUMAN_LEVEL_RANK);
	}
