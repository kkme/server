 ...
 */
@Component
public class GCRefreshDailyQuestList extends GCMessage{
	
	/** 日常任务列表 */
	private com.hifun.soul.gameserver.human.quest.QuestInfo[] questList;

	public GCRefreshDailyQuestList (){
	}
	...
	public short getType() {
		return MessageType.GC_REFRESH_DAILY_QUEST_LIST;
	}
	
	@Override
	public String getTypeName() {
		return "GC_REFRESH_DAILY_QUEST_LIST";
	}
