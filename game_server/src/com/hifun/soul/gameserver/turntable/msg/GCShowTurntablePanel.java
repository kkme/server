 ...
 */
@Component
public class GCShowTurntablePanel extends GCMessage{
	
	/** 抽奖消耗的勇者之心数 */
	private int warriorHeartCost;
	/** 魔晶抽奖次数 */
	...
	public GCShowTurntablePanel (){
	}
	
	public GCShowTurntablePanel (
			int warriorHeartCost,
			...
			this.warriorHeartCost = warriorHeartCost;
	...
	public short getType() {
		return MessageType.GC_SHOW_TURNTABLE_PANEL;
	}
	
	@Override
	public String getTypeName() {
		return "GC_SHOW_TURNTABLE_PANEL";
	}

	public int getWarriorHeartCost(){
		return warriorHeartCost;
	}
		
	public void setWarriorHeartCost(int warriorHeartCost){
		this.warriorHeartCost = warriorHeartCost;
	}
