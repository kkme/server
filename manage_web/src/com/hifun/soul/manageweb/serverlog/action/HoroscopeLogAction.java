...
public class HoroscopeLogAction extends BaseAction {
	/**
	 * 
	 */
	...
	private List<HoroscopeLog> horoscopeLogs;
	...
	public List<HoroscopeLog> getHoroscopeLogs() {
		return horoscopeLogs;
	}

	public void setHoroscopeLogs(List<HoroscopeLog> horoscopeLogs) {
		this.horoscopeLogs = horoscopeLogs;
	}
	...
	public String queryHoroscopeLogList() throws ServiceException{
	    LogRpcService.BlockingInterface serverLogService = Managers.getServiceManager().getServerLogService();
	    QueryHoroscopeLogRequest.Builder request  = QueryHoroscopeLogRequest.newBuilder();
	    ManageLogger.log(ManageLogType.QUERY_HOROSCOPE_LOG_LIST,PermissionType.QUERY_HOROSCOPE_LOG_LIST, "", true);
	    ...
	    QueryHoroscopeLogResponse response = serverLogService.queryHoroscopeLog(null, request.build());
	    horoscopeLogs = response.getHoroscopeLogsList();
