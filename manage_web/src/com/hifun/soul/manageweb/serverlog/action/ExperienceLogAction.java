...
public class ExperienceLogAction extends BaseAction {
	/**
	 * 
	 */
	...
	private List<ExperienceLog> experienceLogs;
	...
	public List<ExperienceLog> getExperienceLogs() {
		return experienceLogs;
	}

	public void setExperienceLogs(List<ExperienceLog> logs) {
	...
	public String queryExperienceLogList() throws ServiceException{
	    LogRpcService.BlockingInterface serverLogService = Managers.getServiceManager().getServerLogService();
	    QueryExperienceLogRequest.Builder request  = QueryExperienceLogRequest.newBuilder();
	    ...
	    QueryExperienceLogResponse response = serverLogService.queryExperienceLog(null, request.build());
	    experienceLogs = response.getLogsList();
