...
public class RechargeLogAction extends BaseAction {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1381544992229307158L;
	...
	public String queryRechargeLogList() throws ServiceException{
	    LogRpcService.BlockingInterface serverLogService = Managers.getServiceManager().getServerLogService();
	    QueryRechargeLogRequest.Builder request  = QueryRechargeLogRequest.newBuilder();
	    ManageLogger.log(ManageLogType.QUERY_RECHARGE_LOG_LIST,PermissionType.QUERY_RECHARGE_LOG_LIST, "", true);
	    ...
	    QueryRechargeLogResponse response = serverLogService.queryRechargeLog(null, request.build());
	    rechargeLogs = response.getRechargeLogsList();
