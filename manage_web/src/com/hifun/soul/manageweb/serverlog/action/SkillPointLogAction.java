...
public class SkillPointLogAction extends BaseAction {
	/**
	 * 
	 */
	...
	private List<SkillPointLog> skillPointLogs;
	...
	public List<SkillPointLog> getSkillPointLogs() {
		return skillPointLogs;
	}

	public void setSkillPointLogs(List<SkillPointLog> skillPointLogs) {
		this.skillPointLogs = skillPointLogs;
	}
	...
	public String querySkillPointLogList() throws ServiceException{
	    LogRpcService.BlockingInterface serverLogService = Managers.getServiceManager().getServerLogService();
	    QuerySkillPointLogRequest.Builder request  = QuerySkillPointLogRequest.newBuilder();
	    ...
	    QuerySkillPointLogResponse response = serverLogService.querySkillPointLog(null, request.build());
	    skillPointLogs = response.getLogsList();
