...
public class FriendLogAction extends BaseAction {
	/**
	 * 
	 */
	...
	private List<FriendLog> friendLogs;
	...
	public String queryFriendLogList() throws ServiceException{
	    LogRpcService.BlockingInterface serverLogService = Managers.getServiceManager().getServerLogService();
	    QueryFriendLogRequest.Builder request  = QueryFriendLogRequest.newBuilder();
	    ManageLogger.log(ManageLogType.QUERY_FRIEND_LOG_LIST,PermissionType.QUERY_FRIEND_LOG_LIST, "", true);
	    ...
	    QueryFriendLogResponse response = serverLogService.queryFriendLog(null, request.build());
	    friendLogs = response.getFriendLogsList();
