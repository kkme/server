...
public class QuestLogAction extends BaseAction {
	/**
	 * 
	 */
	...
	public List<QuestLog> getQuestLogs() {
		return questLogs;
	}

	public void setQuestLogs(List<QuestLog> questLogs) {
	...
	public String queryQuestLogList() throws ServiceException{
	    LogRpcService.BlockingInterface serverLogService = Managers.getServiceManager().getServerLogService();
	    QueryQuestLogRequest.Builder request  = QueryQuestLogRequest.newBuilder();
	    ManageLogger.log(ManageLogType.QUERY_QUEST_LOG_LIST,PermissionType.QUERY_QUEST_LOG_LIST, "", true);
	    ...
	    QueryQuestLogResponse response = serverLogService.queryQuestLog(null, request.build());
	    questLogs = response.getQuestLogsList();
