...
<%@page import="com.hifun.soul.proto.services.LogServices.EnergyLog"%>
...
<body>
	<s:form action="queryEnergyLogList">
		<table>
			<tr>
				<td colspan="18">开始日期
			...
			<%
				Object logObject = request.getAttribute("energyLogs");
					if (logObject != null ) {
						@SuppressWarnings("unchecked")
						List<EnergyLog> energyLogs = (List<EnergyLog>) logObject;
						DateFormat dfDateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
						int index = 1;
						for (EnergyLog log : energyLogs) {
			%>
			<tr>
				<td><%=index++ %></td>
