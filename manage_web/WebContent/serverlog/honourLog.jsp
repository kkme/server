...
<%@page import="com.hifun.soul.proto.services.LogServices.HonourLog"%>
...
<body>
	<s:form action="queryHonourLogList">
		<table>
			<tr>
				<td colspan="18">开始日期
			...
			<%
				Object logObject = request.getAttribute("honourLogs");
					if (logObject != null ) {
						@SuppressWarnings("unchecked")
						List<HonourLog> logList = (List<HonourLog>) logObject;
						DateFormat dfDateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
						int index = 1;
						for (HonourLog log : logList) {
			%>
			<tr>
				<td><%=index++ %></td>
