...
<%@page import="com.hifun.soul.proto.services.LogServices.TechPointLog"%>
...
<body>
	<s:form action="queryTechPointLogList">
		<table>
			<tr>
				<td colspan="18">开始日期
			...
			<%
				Object logObject = request.getAttribute("techPointLogs");
					if (logObject != null ) {
						@SuppressWarnings("unchecked")
						List<TechPointLog> logList = (List<TechPointLog>) logObject;
						DateFormat dfDateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
						int index = 1;
						for (TechPointLog log : logList) {
			%>
			<tr>
				<td><%=index++ %></td>
