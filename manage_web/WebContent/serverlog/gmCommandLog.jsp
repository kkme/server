...
<%@page import="com.hifun.soul.proto.services.LogServices.GMCommandLog"%>
...
<body>
	<s:form action="queryGMCommandLogList">
		<table>
			<tr>
				<td colspan="17">开始日期
			...
			<%
				Object logObject = request.getAttribute("gmCommandLogs");
					if (logObject != null ) {
						@SuppressWarnings("unchecked")
						List<GMCommandLog> gmCommandLogs = (List<GMCommandLog>) logObject;
						DateFormat dfDateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
						int index = 1;
						for (GMCommandLog log : gmCommandLogs) {
			%>
			<tr>
				<td><%=index++ %></td>
