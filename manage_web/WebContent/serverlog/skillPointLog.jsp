...
<%@page import="com.hifun.soul.proto.services.LogServices.SkillPointLog"%>
...
<body>
	<s:form action="querySkillPointLogList">
		<table>
			<tr>
				<td colspan="18">开始日期
			...
			<%
				Object logObject = request.getAttribute("skillPointLogs");
					if (logObject != null ) {
						@SuppressWarnings("unchecked")
						List<SkillPointLog> logList = (List<SkillPointLog>) logObject;
						DateFormat dfDateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
						int index = 1;
						for (SkillPointLog log : logList) {
			%>
			<tr>
				<td><%=index++ %></td>
