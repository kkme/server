...
<%@page import="com.hifun.soul.proto.services.LogServices.ChatLog"%>
...
<body>
	<s:form action="queryChatLogList">
		<table>
			<tr>
				<td colspan="20">开始日期
			...
			<%
				Object logObject = request.getAttribute("chatLogs");
					if (logObject != null ) {
						@SuppressWarnings("unchecked")
						List<ChatLog> chatLogs = (List<ChatLog>) logObject;
			...
			<tr>
				...
				<td><%=log.getDestPassportId() %></td>
				<td><%=log.getDestRoleName() %></td>
				<td><%=log.getChatType() %></td>
