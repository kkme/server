...
<%@page import="com.hifun.soul.proto.services.LogServices.BattleLog"%>
...
<body>
	<s:form action="queryBattleLogList" >
		<table>
			<tr>
				<td colspan="19">开始日期
			...
			<%
				Object logObject = request.getAttribute("battleLogs");
					if (logObject != null ) {
						@SuppressWarnings("unchecked")
						List<BattleLog> battleLogs = (List<BattleLog>) logObject;
			...
			<tr>
				...
				<td><%=log.getStageId() %></td>
				<td><%=log.getResult() %></td>
				<td><%=log.getItemIds() %></td>
