...
<table>
			...
			<s:iterator value="mailList" var="mailModel" status="status">
				...
				<s:elseif test="#mailModel.mailType==2">
					...
					<td>
						<s:date name="#mailModel.planSendTime" format="yyyy-MM-dd HH:mm:ss"/>
					</td>
					<td>
						<s:a href="cancelTimingMail.action?mailId=%{#mailModel.mailId}" theme="simple">取消发送</s:a>&nbsp;&nbsp;						
						<s:a href="updateTimingMailForward.action?mailId=%{#mailModel.mailId}" theme="simple">更新</s:a>&nbsp;&nbsp;
