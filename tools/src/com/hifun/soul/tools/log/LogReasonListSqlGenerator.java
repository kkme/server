package com.hifun.soul.tools.log;
...
import com.hifun.soul.common.LogReasons.ILogReason;
import com.hifun.soul.common.LogReasons.LogDesc;
import com.hifun.soul.common.LogReasons.ReasonDesc;

/**
 * 生成reason_list表的初始化sql的脚本工具: 
 * 先查找{@value #packageName} 包中所有以Log结尾的类,
 * 同时在{@value #reasonParentClass}找到相同类名的Reason定义后生成插入的sql语句
 * 
 */
public class LogReasonListSqlGenerator {
	private static final String packageName = "com.hifun.soul.logserver.model";
	private static final String reasonParentClass = "com.hifun.soul.common.LogReasons";

	public static void main(String[] args) throws Exception {
		// 查找packageName中所有已Log结尾的文件
