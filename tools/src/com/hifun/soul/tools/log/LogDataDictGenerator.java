...
public class LogDataDictGenerator {
	/** 日志类 */
	private static final String LOG_REASON_CLAZZ = "com.hifun.soul.common.LogReasons";
	/** 日志数据字典 */
	...
	public void generate() {
		System.out.println("begin to createGenLogTypeList");
		// 获取日志类型列表
		List<GenLogType> genLogTypeList = this.createGenLogTypeList();
		
		System.out.println("begin to writeOutXls");
		// 输出文本文件
