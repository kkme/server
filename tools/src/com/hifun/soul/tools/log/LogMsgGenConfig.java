...
public class LogMsgGenConfig implements Config {
	...
	public void setCoreSrcGenDir(String coreSrcGenDir) {
		this.coreSrcGenDir = coreSrcGenDir;
	}

	public String getCoreSrcGenDir() {
		return coreSrcGenDir;
	}
