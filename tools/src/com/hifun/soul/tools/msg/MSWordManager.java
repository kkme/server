...
public class MSWordManager {
	...
	public int getTableCount() {
		...
		// FIXME: crazyjohn Dispatch.get(tables, "Count").toInt();
	...
	public void createTable(int numCols, int numRows) {// (String pos, int
		...
		// {
		// if (!find(pos)) {
		// FUCKDispatch tables = Dispatch.get(doc, "Tables").toDispatch();
		// FUCKDispatch range = Dispatch.get(selection, "Range").toDispatch();
		// FUCK Dispatch newTable = Dispatch.call(tables, "Add", range,
	...
	public void callWordMacro() {
		Dispatch tables = Dispatch.get(doc, "Tables").toDispatch();
		// FUCK int count = Dispatch.get(tables, "Count").toInt();
		Variant vMacroName = new Variant("Normal.NewMacros.tableFit");
		// FUCK Variant vParam = new Variant("param1");
