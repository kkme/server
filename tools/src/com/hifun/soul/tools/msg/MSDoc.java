...
public class MSDoc {
	...
	public static final Namespace NAME_SPACE = Namespace.getNamespace("http://com.imop.tr.message");
	...
	private void createFiles(List<Element> messages, String module) throws Exception {
		...
		Map<String,Short> map = (Map<String,Short>)msgNAN.getNameAndNum(MessageType.class);
