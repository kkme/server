package com.hifun.soul.logserver.telnet;
...
import com.hifun.soul.logserver.LogMessageHandler;
...
public class TelnetServerProcess {
	...
	private final LogMessageHandler ioHandler;
	/** 启动的IoAcceptor接口 */
	private final List<IoAcceptor> acceptors = new ArrayList<IoAcceptor>();

	public TelnetServerProcess(String name, String ip, String port, LogMessageHandler ioHandler) {
		this.name = name;
		String _ip = null;
